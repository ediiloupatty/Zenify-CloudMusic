              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 w-1/2">
                    <div className="relative w-12 h-12 rounded-lg overflow-hidden flex-shrink-0 shadow-md group-hover:shadow-[0_0_12px_rgba(45,212,191,0.3)] transition-shadow">
                      {/* Generated cover art (always shown) */}
